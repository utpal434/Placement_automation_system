...
?>
<div class="col-md-9 main" style="height:450px;">
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        $graduation_result = trim($row['graduation_result']);
                         echo '<div class="col-md-5 top-text" style="border: #d58512 solid 1px; padding: 20px;margin: 25px">
                                ...
                                <h5 class="top">'.$drive_title.'</h5>
                                    <p></p>
                                    <p>On '.$dod.'
                                    <a class="span_link" href="Login.php?id='.$drive_id.'">
                                    <span class="glyphicon glyphicon-circle-arrow-right"></span> Login to Apply</a></p>
                                </div>';
                    }
                     ?>
                </div>
    ...
    <div class="banner-right-text" style="height:400px;">
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($result)) { {
                                   ...
                                   echo '
                                    ...
                                    <h4 class="inner two"><a href="Login.php?id='.$id.'">'.$name.'</a>
                                    </h4>
                                    <h5>&nbspBranch: '.$branch.'&nbsp&nbsp&nbsp
                                    <a href="http://'.$url.'" target="_blank">Url: '.$url.'</a>
                                    </h5>
                                </div>
                                </div>
                                    ';
